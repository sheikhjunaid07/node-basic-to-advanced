/* url routing & method checking : it is a mechanism to redirect from one application url to another , to extract url path from req.url , url parsing is to be done */

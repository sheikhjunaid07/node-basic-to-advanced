...
http
  .createServer((req, res) => {
    ...
    if (urlObj.pathname == "/" || urlObj.pathname == "/home")
      ...
      if (req.method == "GET") msg = "<h1> In /service GET method called.</h1>";
      else if (req.method == "POST")
        msg = "<h1> In /service POST method called. </h1>";
      else if (req.method == "PATCH")
        msg = "<h1> In /service PATCH method called. </h1>";
      else if (req.method == "DELETE")
        msg = "<h1> In /service DELETE method called.</h1>";
      else msg = "<h1> Anonymous Method called!!! </h1>";
    } else if (urlObj.pathname == "/register")
      msg = "<h1>/service invoked.</h1>";
